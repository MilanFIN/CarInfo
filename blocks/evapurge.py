...
class EvaporativePurge(BaseBlock):
	...
	def click(self):
		return ""
	def update(self):
		gear = self.connection.getValue("evaporativepurge")
		self.value = gear
	...
	def render(self):
		...
		text2 = font2.render("Evap.", False, (255,255,255))
		text3 = font2.render("purge", False, (255,255,255))
