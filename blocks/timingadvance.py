...
class TimingAdvance(BaseBlock):
	...
	def click(self):
		return ""
	def update(self):
		gear = self.connection.getValue("timingadvance")
		self.value = gear
	...
	def render(self):
		...
		text2 = font2.render("Timing", False, (255,255,255))
		text3 = font2.render("advance", False, (255,255,255))
